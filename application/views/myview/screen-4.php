...
<body id="join">
	<div class="top-menu">
		<div class="wrapper">
			<a href="default_page.php" class="logo-black">LinkedIn</a>
				...
				<div id="content">
					...
					<div id="extra">
						<div class="sign-in-with">
							...
							<p><a href="default_page.php" class="fb_button"><span class="fb_button_text">Sign up with Facebook</span></a></p>
						</div>
					</div>
				</div>
				<p id="agreement">
				 * By joining LinkedIn, you agree to LinkedIn's <a href="default_page.php" target="_blank">User Agreement</a>, <a href="default_page.php" target="_blank">Privacy Policy</a> and <a href="default_page.php" target="_blank">Cookie Policy</a>
				</p>			
			</div>
